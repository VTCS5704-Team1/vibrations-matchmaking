...
def calculate_match_score(user1, user2):
    ...
    # Check if there is any intersection in favorite songs
    if any(song in user1.fav_song for song in user2.fav_song):
        score += 1

    # Check if there is any intersection in favorite artists
    if any(artist in user1.fav_artist for artist in user2.fav_artist):
        score += 1

    # Check if there is any intersection in favorite genres
    if any(genre in user1.fav_genre for genre in user2.fav_genre):
        score += 1
