...
class User:
    def __init__(self, user_id, first_name, last_name, profile_picture_link, email, phone_no, fav_songs, fav_artists, fav_genres, latitude, longitude, max_dist):
        ...
        self.fav_songs = fav_songs.split(",")  # Convert comma-separated strings to lists
        self.fav_artists = fav_artists.split(",")
        self.fav_genres = fav_genres.split(",")
...
# Example: Provide the path to your modified CSV file
csv_file_path = 'users_profiles.csv'
